  ...
  return (
    <div className="">
      ...
      >
        <button
          onClick={() => dispatch(toggleSidebar())}
          className="text-gray-500 md:hidden absolute top-2 right-2 hover:text-gray-700"
        >
        ...
        <div className="mb-5">
          ...
          <Link
            to="/profile"
            onClick={() => dispatch(toggleSidebar())}
            className="text-gray-900 text-base leading-normal mb-3 bg-emerald-100 text-center p-4 rounded-3xl font-bold hover:bg-emerald-200 hover:text-emerald-800 transition-colors duration-300 block flex items-center justify-center gap-2"
          >
